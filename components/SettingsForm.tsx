    ...
    return (
        <Tabs defaultValue="company" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-8 h-12">
                <TabsTrigger value="company" className="text-base">Dados da Empresa</TabsTrigger>
                <TabsTrigger value="rooms" className="text-base">Salas de Atendimento</TabsTrigger>
            </TabsList>
